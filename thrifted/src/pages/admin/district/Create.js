...
function Create(props) {
    ...
    function adddistrict(e){
        ...
        axios.post('/district',data,config).then(response=>{
            $('.district').val('')
    ...
    return (
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control district"  name="district" onChange={(e)=>setDistrict(e.target.value)}  id="formGroupExampleInput" placeholder="Example input" required/>
        </div>
